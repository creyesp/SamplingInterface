...
Sampling Interface was developed to work in anything Operative System (Mac OS, GNU/Linux, Win), it only need to have still the follow requisites:
  * > 4GB  of Ram
  * Matlab > v2012
  * [[http://www.psychtoolbox.org/|Psychophysics Toolbox]] > v3.0. The installing has to add the functions to Matlab library for correct work, it hasn't to work from ptb3-matlab.
==== Install ====
The code is hosted in [[https://github.com/creyesp/SamplingInterface|Github]] where you can download the latest version in this [[https://github.com/creyesp/SamplingInterface/archive/master.zip|link]].
...
For more information you can see the manual in [[https://github.com/creyesp/SamplingInterface/raw/master/Doc/Manual_de_usuario_para_SamplingInterface_v2.pdf|PDF]], here you will find specific information about parameters of configuration in each protocol type.
===== Examples =====
<img style="float: right;" src="Doc/img/wiki/samplinginterface.png">
==== Light Flash ====
...
<img style="float: right;" src="Doc/img/wiki/whatever.jpg">
...
<img style="float: right;" src="Doc/img/wiki/whitenoise.png">
...
<img style="float: right;" src="Doc/img/wiki/nat_img.png">
...
<img style="float: right;" src="Doc/img/wiki/mask_wiki.png">
...
===== Contributing =====
The code is available at [[https://github.com/creyesp/SamplingInterface]]. This repository has the code to create protocols and execute them. It also has the code to create a sequence of images with patterns and complements to correct the parameters in a protocol file after its creation.
...
<img style="float: right;" src="Doc/img/wiki/moveprotocol.png">
So, open Matlab and enter the [[https://github.com/creyesp/SamplingInterface/tree/master/Code/otherCodes | SamplingInterface/Code/otherCodes/]] folder and run in the terminal GUI_updatePosition that open the graphic interface.
...
Fullfield chirp is a Matlab script to create a sequence of images to reproduce the stimuli of //"The functional diversity of retinal ganglion cells in the mouse"// [[https://www.nature.com/articles/nature16468.pdf | paper ]]. This is used to characterize the response to different type of RGC. it has a simple light flash, a frequency modulation, a intensity modulation and a flash of green-blue light . 

<img style="float: right;" src="Doc/img/wiki/fulfieldchirp.png">
The code is [[https://github.com/creyesp/SamplingInterface/blob/master/extra/Protocol_builder/full%20field%20chirp/fullfield_chirp.m | here]] and you can change all parameters to generate a new sequence of images. Some parameters is times, frequency, intensity, adaptation time, etc.
...
All description of how I use the code is in this [[ https://github.com/creyesp/SamplingInterface/blob/master/extra/Protocol_builder/SlantedBar/slantedBarBuilder.py|link]]
...
<img style="float: right;" src="Doc/img/wiki/slantedbar.gif">
